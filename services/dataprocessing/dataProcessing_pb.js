...
goog.exportSymbol('proto.dataprocessing.FindRecurringTransactionsResponse', null, global);
 ...
 * @constructor
 */
proto.dataprocessing.FindRecurringTransactionsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dataprocessing.FindRecurringTransactionsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dataprocessing.FindRecurringTransactionsResponse.displayName = 'proto.dataprocessing.FindRecurringTransactionsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.dataprocessing.FindRecurringTransactionsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.dataprocessing.FindRecurringTransactionsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dataprocessing.FindRecurringTransactionsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dataprocessing.FindRecurringTransactionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dataprocessing.FindRecurringTransactionsResponse}
 */
proto.dataprocessing.FindRecurringTransactionsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dataprocessing.FindRecurringTransactionsResponse;
  return proto.dataprocessing.FindRecurringTransactionsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dataprocessing.FindRecurringTransactionsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dataprocessing.FindRecurringTransactionsResponse}
 */
proto.dataprocessing.FindRecurringTransactionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dataprocessing.FindRecurringTransactionsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dataprocessing.FindRecurringTransactionsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dataprocessing.FindRecurringTransactionsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dataprocessing.FindRecurringTransactionsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.dataprocessing.FindRecurringTransactionsResponse.prototype.getSuccess = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.dataprocessing.FindRecurringTransactionsResponse} returns this
 */
proto.dataprocessing.FindRecurringTransactionsResponse.prototype.setSuccess = function(value) {
