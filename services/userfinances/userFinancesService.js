...
const { GetFinancialInstitutionsRequest, GetFinancialAccountsRequest, ToggleFinancialAccountRequest, GetFinancialTransactionsRequest, Empty } = require('./userFinances_pb.js');


// getFinancialInstitutions
router.get('/getFinancialInstitutions', (req, res) => {
    const request = new GetFinancialInstitutionsRequest();
    const client = new UserFinancesServiceClient(res.locals.grpcHost, res.locals.creds, res.locals.options);
